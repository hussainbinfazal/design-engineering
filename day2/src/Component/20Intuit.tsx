...
export async function Intuit() {
    return <main className="min-h-screen w-full flex flex-col">
        ...
        <section className="w-full flex flex-col flex-1 bg-linear-to-b from-black to-blue-500">
            ...
            <div className="flex flex-1  items-start justify-center ">
                ...
                <div className="h-full bg-yellow-100 relative min-w-1/2  flex flex-col items-center justify-center">
                <Image
                src="/intuit.png"
